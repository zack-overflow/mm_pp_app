...
if os.path.exists("/var/data/data.json"):
    ...
    TEAM_IN_PROGRESS_MASK_JSON_FILE_PATH = "/var/data/team_in_progress_mask.json"
    PROJECTIONS_JSON_FILE_PATH = "/var/data/projections.json"
    PK_PROJECTIONS_JSON_FILE_PATH = "/var/data/pk_projections.json"
    ...
    TEAM_IN_PROGRESS_MASK_JSON_FILE_PATH = "team_in_progress_mask.json"
    PROJECTIONS_JSON_FILE_PATH = "projections.json"
    PK_PROJECTIONS_JSON_FILE_PATH = "pk_projections.json"
